            ...
            try
            {
                ...
                if ((inputLine = in.readLine()) != null) {
                    ...
                    if(inputLine.charAt(0) == 'C'){ // deal with the chess move information
                        ...
                        Platform.runLater(()-> {
//                        System.out.println("Begin to draw the opponent chess.");
...
//        boolean flag = false;
        ...
        Platform.runLater(()-> {
        controller.game_panel.setOnMouseClicked(mouseEvent ->
        {
...
//                System.out.println("Everything finish");
                controller.game_panel.setOnMouseClicked(null); // Cancel the listening.
            }
        });
        });
